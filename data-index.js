...
window.DAILY_NEWS = {
  ...
  editions: [
    {"date": "2026-07-10", "color": "navy", "theme": {"en": "Heat, Hard Power and the Cost of Keeping Flows Open", "zh": "熱浪、硬實力與維持流動暢通的代價"}, "summary": {"en": "From ASEAN diplomacy and Gulf security shocks to AI financing, World Cup pressure, Hormuz shipping disruption, industrial procurement, storm-risk markets, extreme heat, tighter regulation, cyber intrusions and rail-port investment, today's edition tracks how governments and companies are paying more to keep critical flows open across connected systems.", "zh": "從東協外交與波灣安全衝擊，到 AI 融資、世界盃壓力、荷莫茲航運中斷、工業採購、風暴風險下的市場、極端高溫、監管收緊、網路入侵與鐵路港口投資，今日版面聚焦政府與企業如何付出更高代價，維持彼此連動系統中的關鍵流動持續開放。"}},
    {"date": "2026-07-09", "color": "navy", "theme": {"en": "Harder Signals, Tighter Systems", "zh": "訊號轉硬、系統收緊"}, "summary": {"en": "From Kazakhstan's court ruling and Iran-linked market swings to AI controls, World Cup pressure, Hormuz shipping risk, tariff friction, climate stress, antitrust fights, crypto security and disrupted infrastructure, today's edition follows how governments and companies are adjusting as geopolitical signals harden and operating systems tighten.", "zh": "從哈薩克法院裁決與伊朗相關市場震盪，到 AI 管制、世界盃壓力、荷莫茲航運風險、關稅摩擦、氣候壓力、反壟斷攻防、加密安全與基礎設施干擾，今日版面聚焦在地緣訊號轉趨強硬之際，政府與企業如何調整愈發緊繃的運作系統。"}},
